...
def evaluate(opt):
    ...
    if opt.ext_disp_to_eval is None:
        ...
        # encoder = networks.TinyViM_S(opt.pretrained_weights)
        ...
        depth_decoder = networks.FusionDecoder(encoder.num_ch_enc, scales=range(4))
        ...
        with torch.no_grad():
            ...
            for data in dataloader:
                ...
                for i in range(1):
                    ...
                    sencoder = ((t1 - t0) * 1000 / 16)
                    print("编码器时间（毫秒）:", (t1 - t0) * 1000 / 16)
                    ...
                    sdecoder = ((t3 - t2) * 1000 / 16)
                    print("解码器时间（毫秒）:", (t3 - t2) * 1000 / 16)
                    if(speed > (sencoder + sdecoder)):
                        speed = (sencoder + sdecoder)
    ...
    print("運行最小时间（毫秒）:", speed)
    # print("解码器最小时间（毫秒）:", sdecoder)
